...
const penPrintProductBody = {
  ...
  usernamePlaceholder: Joi.string().allow('', null),
...
export const penPrintProductSchema = Joi.object({
  body: Joi.object(penPrintProductBody),
  params: Joi.object(),
  query: Joi.object(),
});

export const penPrintProductUpdateSchema = Joi.object({
  body: Joi.object({
    ...penPrintProductBody,
    title: penPrintProductBody.title.optional(),
...
export const penPrintProductListSchema = Joi.object({
  body: Joi.object(),
  params: Joi.object(),
  query: Joi.object({
